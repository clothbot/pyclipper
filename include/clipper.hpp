...
public:
  Clipper();
  ~Clipper();
  bool Run(ClipType clipType,   Polygons &solution,   PolyFillType subjFillType = pftEvenOdd,   PolyFillType clipFillType = pftEvenOdd){
	  return Execute( clipType,   solution,  subjFillType,  clipFillType);  
  };
